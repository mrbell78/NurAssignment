...
//
//     final responseMailInbox = responseMailInboxFromJson(jsonString);

import 'dart:convert';

ResponseMailInbox responseMailInboxFromJson(String str) => ResponseMailInbox.fromJson(json.decode(str));

String responseMailInboxToJson(ResponseMailInbox data) => json.encode(data.toJson());

class ResponseMailInbox {
  ResponseMailInbox({
    this.context,
    this.id,
    this.type,
  ...
  factory ResponseMailInbox.fromJson(Map<String, dynamic> json) => ResponseMailInbox(
...
class HydraMember {
  ...
  factory HydraMember.fromJson(Map<String, dynamic> json) => HydraMember(
    ...
    to: json["to"] == null ? null : List<From>.from(json["to"].map((x) => From.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "to": to == null ? null : List<dynamic>.from(to.map((x) => x.toJson())),
